...
function PracticalTool:Constructor()
    ...
    local TocPricesModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn1", L["ICC物价"], function()
        self:OnTocPricesModuleClick()
    end )
    TocPricesModule:SetPoint("LEFT", self.Toolbar, "LEFT", 20, 0)
    ...
    local TaskGuideModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn2", L["任务指引"],  function()
        self:OnTaskGuideModuleClick()
    end)
    TaskGuideModule:SetPoint("LEFT", TocPricesModule, "RIGHT", 20, 0)

    local CustomsModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn3", L["副本攻略"], function()
        self:OnCustomsModuleClick()
    end)
    CustomsModule:SetPoint("LEFT", TaskGuideModule, "RIGHT", 20, 0)

    local RoleReportModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn4", L["角色周报"], function()
        self:OnRoleReportModuleClick()
    end)
    RoleReportModule:SetPoint("LEFT", CustomsModule, "RIGHT", 20, 0)

    local InnateViewerModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn5", L["天赋装备"], function()
        self:OnInnateViewerModuleClick()
    end)
    InnateViewerModule:SetPoint("LEFT", RoleReportModule, "RIGHT", 20, 0)

    local PalmtopModule = self:CreateImageTextModule(self.Toolbar, "Interface/AddOns/MeetingHorn/Media/PracticalTool/iocn6",L["掌上集结号"], function()
        self:OnPalmtopModuleClick()
    end)
    PalmtopModule:SetPoint("LEFT", InnateViewerModule, "RIGHT", 20, 0)
    ...
    self.VXFontString:SetText(L["微信扫码"])
