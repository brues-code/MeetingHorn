...
L['按键已绑定到|cffffd100%s|r，你确定要覆盖吗？'] = '按键已绑定到|cffffd100%s|r，你确定要覆盖吗？'
...
L['导入关键字'] = '导入关键字'
L['导出关键字'] = '导出关键字'
L['请输入需要屏蔽的关键字'] = '请输入需要屏蔽的关键字'
L['匹配?'] = '匹配?'
L['添加失败，关键字错误。'] = '添加失败，关键字错误。'
L['添加失败，关键字“%s”已存在。'] = '添加失败，关键字“%s”已存在。'
L['添加成功，关键字“%s”已添加。'] = '添加成功，关键字“%s”已添加。'
L['删除失败，关键字错误。'] = '删除失败，关键字错误。'
L['删除失败，关键字“%s”不存在。'] = '删除失败，关键字“%s”不存在。'
L['删除成功，关键字“%s”已删除。'] = '删除成功，关键字“%s”已删除。'
...
L.TIP_SUMMARY = [[● 目前魔兽世界怀旧服星团长系统处于更新改版阶段，预计完成时间不晚于2026年1月31
日。当前所有通过怀旧服“熊猫人之谜”、周年服认证成功的星团长将会在泰坦时光服
自动获得LV1星标。且认证成功的星团长在泰坦时光服产生的有效开团也会获得相
应的经验。星团长系统改版完成后，这部分经验将会自动累计，用于星标等级提升，
且系统会解锁专门的泰坦时光服星团长主页。但在系统改版完成之前，泰坦时光服
星团长等级会临时锁定在LV1，且暂时无法查询相应的星团长主页信息还请耐心等待。
● 使用网易大神APP扫描右侧二维码，了解更多有关如何认证、查找星团长的详细信息。
]]

L.TIP_TITLE = [[集结号提示：]]

L['玛丁雷少校'] = '玛丁雷少校'
L['暴风城的城民和盟友们'] = '暴风城的城民和盟友们'
L['看看强大的联盟吧'] = '看看强大的联盟吧'
L['艾法希比元帅'] = '艾法希比元帅'
L['联盟的人民们'] = '联盟的人民们'
L['兴奋起来'] = '兴奋起来'
L['伦萨克'] = '伦萨克'
L['部落的人民，奥格瑞玛的居民'] = '部落的人民，奥格瑞玛的居民'
L['在屠龙大军的战斗号角声中精神抖擞地前进吧'] = '在屠龙大军的战斗号角声中精神抖擞地前进吧'
L['萨鲁法尔大王'] = '萨鲁法尔大王'
L['奈法利安被杀掉了'] = '奈法利安被杀掉了'
L['为他的胜利而狂欢吧'] = '为他的胜利而狂欢吧'
L['萨尔'] = '萨尔'
L['奈法利安被杀掉了'] = '奈法利安被杀掉了'
L['为他的胜利而狂欢吧'] = '为他的胜利而狂欢吧'
L['为你们的英雄而欢庆'] = '为你们的英雄而欢庆'
L['沐浴在我的力量中吧'] = '沐浴在我的力量中吧'

L['二维码尺寸过小'] = '二维码尺寸过小'
L['加载中'] = '加载中'

L['欢迎来到%s，打开集结号查看|cff47e53d|Hmeetinghornencounter:%s|h[Boss击杀攻略]|r。'] = '欢迎来到%s，打开集结号查看|cff47e53d|Hmeetinghornencounter:%s|h[Boss击杀攻略]|r。'
L['你在与[%s]的战斗中阵亡，|cff00ffff|Hmeetinghornencounter:%s:%s:%s|h[点击查看Boss攻略]|h|r。'] = '你在与[%s]的战斗中阵亡，|cff00ffff|Hmeetinghornencounter:%s:%s:%s|h[点击查看Boss攻略]|h|r。'
L['近战输出者预警'] = '近战输出者预警'
L['远程输出者预警'] = '远程输出者预警'
...
L['申请星团长'] = '申请星团长'
L['直充专区'] = '直充专区'
L['支付宝/微信扫码登录充值更便捷时时有特惠'] = '支付宝/微信扫码登录充值更便捷时时有特惠'
L['熔火'] = '熔火'
L['日常'] = '日常'
L['周常'] = '周常'
L['随机'] = '随机'
